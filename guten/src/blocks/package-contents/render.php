...
$domca_package_contents_feature1_details = $attributes['feature1Details'] ?? [];
$domca_package_contents_feature2_title   = $attributes['feature2Title'] ?? '';
$domca_package_contents_feature2_details = $attributes['feature2Details'] ?? [];
$domca_package_contents_feature3_title   = $attributes['feature3Title'] ?? '';
$domca_package_contents_feature3_details = $attributes['feature3Details'] ?? [];
$domca_package_contents_feature4_title   = $attributes['feature4Title'] ?? '';
$domca_package_contents_feature4_details = $attributes['feature4Details'] ?? [];
$domca_package_contents_bonus_title      = $attributes['bonusTitle'] ?? '';
$domca_package_contents_bonus_details    = $attributes['bonusDetails'] ?? [];
