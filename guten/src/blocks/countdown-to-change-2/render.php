...
$domca_countdown_to_change_form_id    = $attributes['dataFormId'] ?? '';
...
$domca_countdown_to_change_block_id    = isset( $attributes['blockId'] ) ? (string) $attributes['blockId'] : '';
...
$domca_countdown_to_change_wrapper_attributes = get_block_wrapper_attributes(
	array(
		'class' => 'dm-wrap',
        'id'                => ! empty( $domca_countdown_to_change_block_id ) ? esc_attr( $domca_countdown_to_change_block_id ) : null,
	)
);

$domca_countdown_to_change_base_class = 'wp-block-domca-countdown-to-change-2';
...
>
	<div class="<?php echo esc_attr( $domca_countdown_to_change_base_class ); ?>__wrap dm-container">
		<div class="<?php echo esc_attr( $domca_countdown_to_change_base_class ); ?>__content-left">
            <?php if ( ! empty( $domca_countdown_to_change_form_id ) ) : ?>
            <div class="ml-embedded" data-form="<?php echo esc_attr($domca_countdown_to_change_form_id); ?>"></div>
            <?php endif; ?>
		</div>
