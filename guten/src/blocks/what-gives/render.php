...
$domca_wg_separator = '<svg
			viewBox="0 0 1920 12"
			fill="none"
			class="' . esc_attr( $domca_wg_base_class . '__separator' ) . '"
...
<section
		...
		?>
>
	<div class="<?php echo esc_attr( $domca_wg_base_class . '__inner' ); ?>">
		<?php echo wp_kses( $domca_wg_separator, domca_get_svg_allowed_html() ); ?>
		<?php echo wp_kses( $domca_wg_separator, domca_get_svg_allowed_html() ); ?>
